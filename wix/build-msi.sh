...
LDFLAGS="github.com/matthiasderosa/cloud-print-connector/lib.BuildDate=$CONNECTOR_VERSION"
CONNECTOR_DIR=$GOPATH/src/github.com/matthiasderosa/cloud-print-connector
...
echo "Running go get..."
go get -ldflags -X="$LDFLAGS" -v github.com/matthiasderosa/cloud-print-connector/...
rc=$?
if [[ $rc != 0 ]]; then
